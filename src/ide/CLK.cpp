...
reg* CLK::registerList[] = // registers are in no particular sequence
{
	...
	&OUTP::register_OUT1, &OUTP::register_OUT2, 
	&OUTP::register_OUT3, &OUTP::register_OUT4,
	...
	&INTR::register_RPCELL, &INTR::register_INHINT1, &INTR::register_INHINT,
...
void CLK::clkAGC()
{
	...
	void execR_RA11()	{ OUTP::execRP_RA11(); }
	void execR_RA12()	{ OUTP::execRP_RA12(); }
	void execR_RA13()	{ OUTP::execRP_RA13(); }
	void execR_RA14()	{ OUTP::execRP_RA14(); }
	...
	void execR_RRPA()	{ INTR::execRP_RRPA(); }
...
void CLK::doexecR_ALU_OR(int pulse) { execR_ALU_OR[pulse](); } 
	...
	void execW_CLINH()	{ INTR::execWP_CLINH(); }
	void execW_CLINH1()	{ INTR::execWP_CLINH1();	}
	void execW_CLISQ()	{ SEQ::execWP_CLISQ(); }
	void execW_CLCTR()	{ SEQ::execWP_CLCTR(); }
	void execW_CLRP()	{ INTR::execWP_CLRP(); }
	...
	void execW_INH()	{ INTR::execWP_INH(); }
	void execW_KRPT()	{ INTR::execWP_KRPT(); }
	void execW_NISQ()	{ SEQ::execWP_NISQ(); }
	void execW_RPT()	{ INTR::execWP_RPT(); }
	...
	void execW_WA10()	{ OUTP::execWP_WA10(); }
	void execW_WA11()	{ OUTP::execWP_WA11(); }
	void execW_WA12()	{ OUTP::execWP_WA12(); }
	void execW_WA13()	{ OUTP::execWP_WA13(); }
	void execW_WA14()	{ OUTP::execWP_WA14(); }
	...
	void execW_WOVI()	{ INTR::execWP_WOVI(); }
